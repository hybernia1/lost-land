...
export const environmentDefinitions: Record<EnvironmentConditionId, EnvironmentDefinition> = {
  stable: {
    ...
    minDurationHours: 8,
    maxDurationHours: 14,
    moralePenaltyPerHourByIntensity: [0, 0, 0],
    healthIncidentChanceByIntensity: [0, 0, 0],
  },
  rain: {
    id: "rain",
    ...
    minDurationHours: 4,
    maxDurationHours: 8,
    moralePenaltyPerHourByIntensity: [0.25, 0.45, 0.7],
    healthIncidentChanceByIntensity: [2, 4, 6],
  },
  snowFront: {
    id: "snowFront",
    ...
    minDurationHours: 6,
    maxDurationHours: 12,
    moralePenaltyPerHourByIntensity: [0.35, 0.7, 1.1],
    healthIncidentChanceByIntensity: [3, 6, 9],
    shelterDeadlineHoursByIntensity: [10, 7, 5],
  },
  radiation: {
    id: "radiation",
    ...
    minDurationHours: 3,
    maxDurationHours: 7,
    moralePenaltyPerHourByIntensity: [0.55, 0.95, 1.45],
    healthIncidentChanceByIntensity: [8, 14, 22],
  },
};
